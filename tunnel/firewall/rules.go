...
func permitApplications(apps []string, session uintptr, baseObjects *baseObjects, weight uint8) error {
	for _, appPath := range apps {
		...
		//
		// #1 Permit outbound IPv4 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Permit application outbound (IPv4)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #2 Permit inbound IPv4 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Permit application inbound (IPv4)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #3 Permit outbound IPv6 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Permit application outbound (IPv6)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #4 Permit inbound IPv6 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Permit application inbound (IPv6)", appPath)
			if err != nil {
				return wrapErr(err)
			}
...
func blockApplications(apps []string, session uintptr, baseObjects *baseObjects, weight uint8) error {
	for _, appPath := range apps {
		...
		//
		// #1 Block outbound IPv4 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Block application outbound (IPv4)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #2 Block inbound IPv4 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Block application inbound (IPv4)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #3 Block outbound IPv6 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Block application outbound (IPv6)", appPath)
			if err != nil {
				return wrapErr(err)
			}
		...
		//
		// #4 Block inbound IPv6 traffic for this app.
		//
		{
			displayData, err := createWtFwpmDisplayData0("Block application inbound (IPv6)", appPath)
			if err != nil {
				return wrapErr(err)
			}
